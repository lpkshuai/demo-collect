...
- [Get Started | Let's chat(https://conventional-changelog.github.io/commitlint)](#get-started--lets-chat-slack11--website)
  ...
  - [Development](#development)
    ...
    - [Publishing a release](#publishing-a-release)
      ...
      - [Publish a `next` release (or i.e. patch release)](#publish-a-next-release-or-ie-patch-release)
        - [Publishing (new) packages for the first time](#publishing-new-packages-for-the-first-time)
